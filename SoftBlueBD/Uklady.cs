...
namespace SoftBlueBD
{
    public partial class Uklady : Form
    {
        ...
        private void CreateSQLCommand()
        {
            ...
            try
            {
                foreach (string line in System.IO.File.ReadLines(@"KonfiguracjaUklady.ini"))
                {
        ...
        private void fillByUkladToolStripButton_Click(object sender, EventArgs e)
        {
            try
            {
                this.elementyElektroniczneTableAdapter.FillByUklad(this.elementyElektroniczneDataSetUklady.ElementyElektroniczne);
            }
        ...
        private void fillByALLToolStripButton_Click(object sender, EventArgs e)
        {
            try
            {
                this.elementyElektroniczneTableAdapter.FillByALL(this.elementyElektroniczneDataSetUklady.ElementyElektroniczne);
            }
            catch (System.Exception ex)
            {
                System.Windows.Forms.MessageBox.Show(ex.Message);
